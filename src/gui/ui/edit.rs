...
use druid::{
    ...
    widget::{Flex, Label, TextBox, ValueTextBox, ViewSwitcher},
                ...
                |time, _data, _env| match time {
                    Some(_) => Flex::row()
                        .with_child(
                            Maybe::or_empty(|| {
                                Flex::row()
                                    .with_child(Label::new("Hours ").with_font(theme::SMALL_FONT))
                                    .with_spacer(5.0)
                                    .with_child(
                                        ValueTextBox::new(
                                            TextBox::new()
                                    ...
                                    .with_spacer(10.0)
                                    .with_child(Label::new("Minutes ").with_font(theme::SMALL_FONT))
                                    .with_spacer(5.0)
                                    .with_child(
                                        ValueTextBox::new(
                                            TextBox::new()
                                    ...
                                    .with_spacer(10.0)
                                    .with_child(Label::new("Seconds ").with_font(theme::SMALL_FONT))
                                    .with_spacer(5.0)
                                    .with_child(
                                        ValueTextBox::new(
                                            TextBox::new()
